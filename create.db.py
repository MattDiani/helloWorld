...
with app.app_context():
    ...
    students = [
        {'student_id': '1', 'first_name': 'Robert', 'last_name':'Smith', 'email':'rhsmith@umd.edu', 'major_id':3,
    ...
    for each_student in students:
        ...
        a_student = Student(first_name=each_student["first_name"], last_name=each_student["last_name"], email =["email"],
